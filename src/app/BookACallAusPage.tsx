...
export default function BookACallAusPage() {
  return (
    <div className="bg-[#080617] min-h-screen text-[#fffff7] font-sans">
        ...
        <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8 mt-3 sm:mt-4">
          <div className="bg-[rgba(45,42,65,0.4)] backdrop-blur-md rounded-[18px] sm:rounded-[23px] px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between border border-white/5">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              <a href="https://app.theclips.agency" target="_blank" rel="noopener noreferrer" className="hidden sm:inline-flex text-white/60 px-4 md:px-5 py-2 md:py-2.5 rounded-lg text-sm font-medium hover:text-white transition-colors">Client Login</a>
      ...
      <main className="pt-28 sm:pt-36 pb-12 sm:pb-20 max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="w-full rounded-2xl overflow-hidden border border-white/10 bg-white">
          <iframe
            src="https://calendly.com/shafay-theclips/discovery-call?embed_domain=localhost&embed_type=Inline"
            width="100%"
            height="700"
            frameBorder="0"
            title="Schedule a call — Australia"
            className="w-full"
          />
        </div>
      </main>
