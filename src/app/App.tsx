...
export default function App() {
  ...
  return (
    <div className="bg-[#080617] min-h-screen text-[#fffff7] font-sans selection:bg-[#fbe9ff] selection:text-[#080617] overflow-x-hidden">
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 md:py-32">
          <FadeInOnScroll>
            <div className="bg-[#fbe9ff] rounded-[24px] sm:rounded-[40px] p-10 sm:p-16 md:p-24 text-center relative overflow-hidden group shadow-[0_0_80px_rgba(251,233,255,0.05)] border border-[#fbe9ff]/20">
              ...
              <motion.div 
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] bg-white/70 blur-[120px] rounded-full pointer-events-none z-0"
                animate={{ scale: [1, 1.3, 1], opacity: [0.5, 0.8, 0.5] }}
                transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
              />
              
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[56px] font-bold text-[#080617] mb-6 sm:mb-8 tracking-tight relative z-10 leading-[1.1]">
                Closing deals <br /> while you sleep.
              </h2>
              
              <p className="text-[#080617]/80 text-base sm:text-lg md:text-xl max-w-2xl mx-auto mb-10 sm:mb-12 relative z-10 font-medium">
      ...
      {/* ── Footer ── */}
      <footer className="bg-[#080617] text-white py-12 sm:py-20 mt-12 sm:mt-20 relative border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12 md:gap-20">
            <div className="flex-1">
               <div className="mb-4 inline-block">
                 <HyperText className="text-3xl font-black tracking-tight" text="TheClipsAgency" />
               </div>
              <p className="text-white/60 max-w-sm mb-8 leading-relaxed font-medium">Designed to capture your expertise and transform it into strategic content that scales.</p>
              <div className="flex gap-4">
                {/* Instagram */}
                <a href="https://www.instagram.com/theclips.agency/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 hover:scale-110 transition-all cursor-pointer">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/company/the-clips-agency" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 hover:scale-110 transition-all cursor-pointer">
            ...
            <div className="flex-[1.5] grid grid-cols-2 sm:grid-cols-3 gap-10 md:gap-16">
              <div>
                <h4 className="font-bold mb-6 text-white uppercase text-sm tracking-wider">Services</h4>
                <ul className="space-y-4">
                  <li><Link to="/" className="text-white/60 hover:text-white transition-colors text-sm font-medium">Home</Link></li>
                  <li><Link to="/apply" className="text-white/60 hover:text-white transition-colors text-sm font-medium">Process &amp; Pricing</Link></li>
                  <li><a href="#" className="text-white/60 hover:text-white transition-colors text-sm font-medium">Careers</a></li>
                </ul>
              </div>
              <div>
                <h4 className="font-bold mb-6 text-white uppercase text-sm tracking-wider">Resources</h4>
                <ul className="space-y-4">
                  <li><a href="#" className="text-white/60 hover:text-white transition-colors text-sm font-medium">Platform</a></li>
                  <li><a href="#" className="text-white/60 hover:text-white transition-colors text-sm font-medium">Help Center</a></li>
                </ul>
              </div>
              <div className="col-span-2 sm:col-span-1">
                <h4 className="font-bold mb-6 text-white uppercase text-sm tracking-wider">Legal</h4>
                <ul className="space-y-4">
                  <li><a href="#" className="text-white/60 hover:text-white transition-colors text-sm font-medium">Privacy Policy</a></li>
                  <li><a href="#" className="text-white/60 hover:text-white transition-colors text-sm font-medium">Terms of Service</a></li>
                </ul>
              </div>
            </div>
          </div>
          
          <div className="mt-16 sm:mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
            <p className="text-white/40 text-sm font-medium">© {new Date().getFullYear()} TheClipsAgency. All rights reserved.</p>
